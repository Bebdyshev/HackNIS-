    ...
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "dark:bg-[#0f2d16] dark:shadow-sticky-dark fixed z-[9999] bg-white !bg-opacity-60 shadow-sticky backdrop-blur-sm transition"
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <Link
              href="/"
              className={`header-logo block w-full flex text-[25px] font-[600] ${
